 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://eberth/", wsdlLocation = "http://localhost:8081/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://eberth/", "HelloWorldService");
     ...
     * 
     * @return
     *     returns ISimpleInterface
     */
    @WebEndpoint(name = "HelloWorldPort")
    public ISimpleInterface getHelloWorldPort() {
        return super.getPort(new QName("http://eberth/", "HelloWorldPort"), ISimpleInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldPort")
    public ISimpleInterface getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://eberth/", "HelloWorldPort"), ISimpleInterface.class, features);
    }
